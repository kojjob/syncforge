...
#
#     PHX_SERVER=true bin/syncforge start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :syncforge, SyncforgeWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  repo_config =
    case System.get_env("POOL_COUNT") do
      nil -> repo_config
      count -> Keyword.put(repo_config, :pool_count, String.to_integer(count))
    end

  config :syncforge, Syncforge.Repo, repo_config
  ...
  #
  #     config :syncforge, Syncforge.Mailer,
